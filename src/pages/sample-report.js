...
const STYLES = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media screen and (max-width: 640px) {
    ...
    .report-wrapper { padding: 118px 0 24px; }
...
export default function SampleReportPage() {
  ...
  const dealTitle = deal.deal_name;
  ...
  return (
    <>
      <Head>
        <title>MergerAid — Sample Tax Risk Screening Report</title>
      ...
      >
        <span style={{ color: "#92400e", fontSize: "12px" }}>
          This is a sample report generated from fictional data. Purchase a report to screen your own transaction.
        </span>
        <a
          href="/pricing"
          style={{
      ...
      <div className="report-wrapper">
        ...
        {/* PAGE 1 — COVER */}
        <div className="report-section cover-section watermark-page">
          <p className="cover-confidential">Sample Report — Fictional Data Only</p>
          ...
          <div className="cover-meta">
            ...
            <p><strong>Transaction Type:</strong>&nbsp; Equity Purchase</p>
            <p><strong>Date Generated:</strong>&nbsp; {generatedDate}</p>
          </div>
          <p className="cover-fiction-note">
            All company names and figures in this report are fictional and for demonstration purposes only.
          </p>
