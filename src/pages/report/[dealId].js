        ...
        <div className="report-section cover-section">
          ...
          <div className="cover-footer">
            <div>
              ...
              <div className="cover-brand-tagline">Tax Due Diligence Platform</div>
            </div>
                ...
                <tbody>
                  {cleanCategories.map((c, i) => (
                    <tr key={i}>
                      ...
                      <td className="td-clean">No issues were identified in this category based on the information provided.</td>
                    </tr>
                  ))}
                </tbody>
              </table>
